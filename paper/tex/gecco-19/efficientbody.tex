...
\item Confirm the prior work of \cite{cache-pso}
...
architecture. This is primarily due to compiler optimizations. Recall that the
SoA - efficient design has three changes: (i) batched random number generation,
(ii) reduced critical section contention (not applicable in the sequential
case), and (iii) code that hints to the compiler that there is no
aliasing. [REWORD].
